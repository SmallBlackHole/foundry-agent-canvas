...
- Long-lived loopback listeners retained for cached canvas URLs must be unreferenced so they cannot extend the provider process lifetime when the host stops it for update or uninstall.
