...
- Then stop and say: "The Microsoft Foundry canvas is ready — sign in, select a subscription and Foundry project, then click Send to continue." Resume after project context returns; do not repeat this gate for the same request.
