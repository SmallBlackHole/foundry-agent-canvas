...
- If the prompt includes the canvas-generated project context ("Use my selected Foundry project" with a subscription and project endpoint), the user already clicked Start in the canvas. Continue the requested work immediately without opening, focusing, or updating the canvas.
